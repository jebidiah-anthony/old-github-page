...
Base64 decode the given "__memo__"
...
The ciphertext generated has a lot of `1`, `2`, `3`, `5`, and `7` scattered all throughout but __`0`__ and __`8`__ are clustered in the middle.

Marking __`0`__ and __`8`__ gives you:

``` console
$ echo $c | base64 -d | egrep --color -e "[80]"
```

![FLAG](../screenshots/the_sword_flag.png)

---

## FLAG : __flag{pluck}__
